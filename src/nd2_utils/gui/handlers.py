...
class TiffExportHandler:
    ...
    def export_file(self, nd2_path: str, output_path: str, 
                   position: tuple = None, channel: tuple = None,
                   time: tuple = None, z: tuple = None):
        ...
        self.exporter = TiffExporter(
            nd2_path, output_path, position, channel, time, z
        )
...
class GUIEventHandler:
    ...
    def handle_export_request(self, export_params: dict):
        ...
        if ExportConfirmationDialog.confirm_export(
            self.main_window, 
            self.main_window.nd2_info['dimensions'], 
            dim_selection
        ):
